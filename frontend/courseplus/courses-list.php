                    ...
                    <div class="divide-y">
                        <div class="flex md:space-x-6 space-x-3 md:p-5 p-2 relative">
                            <a href="course-intro-2.html" class="md:w-60 md:h-36 w-28 h-20 overflow-hidden rounded-lg relative shadow-sm">
                                <img src="public/assets/images/courses/img-5.jpg" alt=""  class="w-full h-full absolute inset-0 object-cover">
                            ...
                            <div class="flex-1 md:space-y-2 space-y-1">
                                <a href="course-intro-2.html" class="md:text-xl font-semibold line-clamp-2"> Learn C sharp for Beginners Crash Course </a>
