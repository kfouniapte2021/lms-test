                            ...
                            <div class="uk-slider-container px-1 py-3">
                                <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid text-sm font-medium text-center">
                                    ...
                                    <li>
                                        <div class="relative overflow-hidden bg-white shadow md:rounded-lg rounded-md">
                                            <a href="book-description.html">
                                               <img src="public/assets/images/book/book1.jpg" alt="" class="w-full h-44 object-cover">
                                    ...
                                    <li>
                                        <div class="relative overflow-hidden bg-white shadow md:rounded-lg rounded-md">
                                            <a href="book-description.html">
                                               <img src="public/assets/images/book/book2.jpg" alt="" class="w-full h-44 object-cover">
                                    ...
                                    <li>
                                        <div class="relative overflow-hidden bg-white shadow md:rounded-lg rounded-md">
                                            <a href="book-description.html">
                                               <img src="public/assets/images/book/book3.jpg" alt="" class="w-full h-44 object-cover">
                                    ...
                                    <li>
                                        <div class="relative overflow-hidden bg-white shadow md:rounded-lg rounded-md">
                                            <a href="book-description.html">
                                               <img src="public/assets/images/book/book4.jpg" alt="" class="w-full h-44 object-cover">
                                    ...
                                    <li>
                                        <div class="relative overflow-hidden bg-white shadow md:rounded-lg rounded-md">
                                            <a href="book-description.html">
                                               <img src="public/assets/images/book/book5.jpg" alt="" class="w-full h-44 object-cover">
