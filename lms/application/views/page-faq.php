    ...
    <div id="wrapper" class="is-verticle">
     ...
     <?php include_once'inc/header.php'; ?>
        ...
        <div class="main_content">
            ...
            <div class="md:pt-16 md:pb-7 py-6 bg-blue-600 lg:-mt-20">
    
                <div class="container m-auto px-4">
                    
                    <div class="flex flex-col justify-center items-center md:p-7 text-white">
                        
                        <div class="lg:text-4xl text-2xl font-semibold mb-6"> How can we help? </div>

                        <div class="bg-white mb-3 relative rounded-md lg:w-2/3 w-full shadow-md" id="search">
                        ...
                        <p class="text-sm text-center">
                            Popular help topics:
                            <a class="text-gray-200" href="#">pricing,</a>
                            <a class="text-gray-200" href="#">upgrade,</a>
                            <a class="text-gray-200" href="#">ebook,</a>
                            <a class="text-gray-200" href="#">membership</a>
                        </p> 
            ...
            <div class="py-12">
                <div class="container lg:w-10/12"> 
                    ...
                    <h1 class="text-2xl font-semibold mb-4 mt-8"> Privecy</h1>
                    <ul class="uk-accordion space-y-2" uk-accordion="">
                      <li class="bg-white px-6 py-4 rounded shadow hover:shadow-md">
                        <a class="uk-accordion-title text-base" href="#">  Lorem ipsum dolor sit amet, consectetur adipiscing elit? </a>
                        <div class="uk-accordion-content mt-3">
                    ...
                    <h1 class="text-2xl font-semibold mb-4 mt-8"> Account</h1>
                    <ul class="uk-accordion space-y-2" uk-accordion="">
                      <li class="bg-white px-6 py-4 rounded shadow hover:shadow-md">
                        <a class="uk-accordion-title text-base" href="#">  Lorem ipsum dolor sit amet, consectetur adipiscing elit? </a>
                        <div class="uk-accordion-content mt-3">
