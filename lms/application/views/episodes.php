                ...
                <div class="right-side">
                    ...
                    <div>
                        ...
                        <div uk-drop="mode: click" class="header_dropdown">
                         ...
                         <!-- profile -->
                        <a href="#">
                            <img src="public/assets/images/avatars/placeholder.png" class="header_widgets_avatar" alt="">
                        </a>
                    ...
                    <div class="grid lg:grid-cols-4 grid-cols-2 gap-3 mb-5">
                        ...
                        <a href="episodes-watch.html" class="col-span-2 row-span-2"> 
                            <div class="bg-gray-200 rounded-md overflow-hidden relative w-full lg:h-full h-60 shadow-sm">
                                <img src="public/assets/images/blog/img-5.jpg" class="absolute w-full h-full object-cover" alt="">
                        ...
                        <a href="episodes-watch.html">
                            <div class="bg-gray-200 rounded-md overflow-hidden relative w-full lg:h-44 h-36 shadow-sm uk-transition-toggle">
                                <img src="public/assets/images/episodes/img-2.jpg" class="absolute w-full h-full object-cover" alt="">
                        ...
                        <a href="episodes-watch.html">
                            <div class="bg-gray-200 rounded-md overflow-hidden relative w-full lg:h-44 h-36 shadow-sm uk-transition-toggle">
                                <img src="public/assets/images/episodes/img-3.jpg" class="absolute w-full h-full object-cover" alt="">
                        ...
                        <a href="episodes-watch.html">
                            <div class="bg-gray-200 rounded-md overflow-hidden relative w-full lg:h-44 h-36 shadow-sm uk-transition-toggle">
                                <img src="public/assets/images/episodes/img-4.jpg" class="absolute w-full h-full object-cover" alt="">
                        ...
                        <a href="episodes-watch.html">
                            <div class="bg-gray-200 rounded-md overflow-hidden relative w-full lg:h-44 h-36 shadow-sm uk-transition-toggle">
                                <img src="public/assets/images/episodes/img-1.jpg" class="absolute w-full h-full object-cover" alt="">
                            ...
                            <ul class="uk-slider-items uk-child-width-1-5@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid">
                                <li>
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="public/assets/images/category/design.jpg" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li>
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="public/assets/images/category/marketing.jpg" class="absolute w-full h-full object-cover"
                                            alt="">
                                ...
                                <li>
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="public/assets/images/category/it-and-software.jpg" class="absolute w-full h-full object-cover"
                                            alt="">
                                ...
                                <li>
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="public/assets/images/category/music.jpg" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li>
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="public/assets/images/category/business.jpg" class="absolute w-full h-full object-cover" alt="">
                                ...
                                <li>
                                    <div class="rounded-md overflow-hidden relative w-full h-36">
                                        ...
                                        <img src="public/assets/images/category/development.jpg" class="absolute w-full h-full object-cover" alt="">
