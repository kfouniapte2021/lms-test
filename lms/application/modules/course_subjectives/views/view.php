...
>  <?=$course_title?>
     ...
     <a  href="course_subjectives/add/<?=$course_id?>/<?=$quiz_id?>" class="btn btn-sm btn-success pull-right">Add Questions</a><br>
    </section>
...
<tr id="row_<?php echo $row->id;?>">
    ...
    <td class="center">
            ...
            <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Delete'));?>" class="btn btn-xs btn-danger" href="javascript:void(0)" onClick="deleteRecord('<?php echo$row->id;?>','course_subjectives');">
