<?php
 ...
 class Course extends MX_Controller {
	...
	public function index(){  
		...
		$aData['data'] = $this->db->query("SELECT p.*,s.class_name,sb.title as subject FROM ".$this->tbl." p join classes as s on s.id=p.class_id join subjects as sb on sb.id=p.course_category_id");
