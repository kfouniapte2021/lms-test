...
class Registration_pricing extends MX_Controller {
	...
	public $tbl = 'registration_pricing';
	public $tableColmns=array('title','description'); // DB colmn you wish to show in list
	public $formFields=array('title','description'); // DB colmn you wish to show in Form
	public $module_heading='Registration Form Pricing '; 
