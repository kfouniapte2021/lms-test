...
echo $Heading;
      ...
      <ol class="breadcrumb">
        ...
        <li > <a href="<?=$controller?>">View <?=$Heading?> </a></li>
      </ol>
    </section>
					...
					?>
					 <div class="col-xs-12 col-md-12">
                      <label> <?php echo ucfirst($heading) ?></label>
						...
						<?php if(isset($row)){ echo $row->$col;} ?></textarea>
                    </div>
					<?php }else{
						$type='text';
   ...
   $type='date';
        ...
        <div class="col-xs-12 col-md-6">
                      <label for="exampleInputEmail1"><?php echo ucfirst($heading) ?> </label>
                        <input type="<?=$type?>" class="form-control" id="<?=$heading?>"   name="<?=$col?>" value="<?php if(isset($row)){ echo $row->$col;} ?>">
