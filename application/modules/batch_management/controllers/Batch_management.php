...
class Batch_management extends MX_Controller {
	...
	public $tbl = 'batch_session';
	public $tableColmns=array('batch_id','from_date','to_date'); 
	// DB colmn you wish to show in list
	public $formFields=array('from_date','to_date'); 
	// DB colmn you wish to show in Form
	public $module_heading='Batch Management'; 
	...
	function save(){ 
		...
		if ($this->form_validation->run()==false){
			...
			$batch_id=date('Y',strtotime($_POST['from_date']));
			$_POST['batch_id']=$batch_id.date('m',strtotime($_POST['from_date']));
			//pre($_POST);
