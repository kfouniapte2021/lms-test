...
<section class="content-header">
 ...
 <div class="table-responsive">
	...
	foreach ($data->result() as $row){
        ...
        <video id="my-video" controls preload="none"  style="width:150px;"
...
<?php } ?>
    ...
    <a href="course/viewcourselecture/<?php echo $row->id;?>"><button type="button" class="btn btn-xs btn-danger" >Upload / view Lectures</button></a>
            ...
            <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Edit'));?>" class="btn btn-xs btn-info" href="course/edit/<?php echo $row->id;?>">
            ...
            <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Delete'));?>" class="btn btn-xs btn-danger" href="javascript:void(0)" onClick="deleteRecord('<?php echo$row->id;?>','course');">
