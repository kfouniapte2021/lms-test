...
<?php // echo '<pre>'; print_r($data->result()); ?>
            </div>
 ...
 <div class="table-responsive">
	...
	foreach ($data->result() as $row){
        ...
        <td>
         <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Edit'));?>" class="btn btn-xs btn-info" href="assignments/index?course_id=<?php echo $row->id;?>">
                <i class="glyphicon glyphicon-pencil icon-white"></i>
                Assigments
            </a>
         <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Edit'));?>" class="btn btn-xs btn-success" href="attendance/index?course_id=<?php echo $row->class_id;?>&class_id=<?php echo $row->class_id;?>">
                <i class="glyphicon glyphicon-pencil icon-white"></i>
                Attendance
            </a>
        </td>
    ...
    <td class="center">
    <a href="course/viewcourselecture/<?php echo $row->id;?>"><button type="button" class="btn btn-xs btn-danger" >Upload / view Lectures</button></a>
