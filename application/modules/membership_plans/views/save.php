...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li > <a href="<?=$this->router->class?>">View  Plans</a></li>
      </ol>
    </section>
            ...
            <div class="box-body">
             ...
             <div class="col-xs-12"><div class="alert hidden"></div></div>
                    ...
                    <?php /*?><div class="col-xs-12 col-md-6">
                     ...
                     <div class="col-xs-12 col-md-6">
                                             <label > Price <?php CURRENCY_SYMBOL; ?> </label>
                       <input type="text" value="<?php if(isset($row)){ echo $row->price;} ?>" class="form-control" placeholder="300" name="price">

                     </div>
					  <div class="clearfix">&nbsp;</div>
                    <div class="col-xs-12 col-md-12">
                      <label > Description</label>
<textarea class="form-control" rows="10" name="description"><?php if(isset($row)){ echo $row->description;} ?>Lorem ipsum answer</textarea>
                    </div>
	...
	// ajax start
		...
		//	$('#form_add_update .btn_au').addClass('hidden');
			...
			$(".alert").addClass('alert-success');
				...
				$(".alert").removeClass('hidden');
				setTimeout(function(){
				window.location='<?=$this->router->class?>';
				},1000);
            }
