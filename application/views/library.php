...
.single-product-box .product-content h3 {
 ...
 <?php
							...
							?>
                                <a href="javascript:void(0)"  data-toggle="modal" data-target="#exampleModal"   class="add-to-cart-btn">Download <i class='bx bx-download'></i></a>
                                <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Download is available in Mobile App only </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Download Zenith App on Appstore/Playstore to access and download from the Library</p>
      </div>
