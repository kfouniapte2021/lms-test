				...
				?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="single-instructor-member mb-30">
                            <div class="">
                                <img src="<?=$row->image?>" class="img-responsive imgs" alt="images">
                            </div>
                            ...
                            <div class="member-content">
                                ...
                                <div class="btnsdiv">
                                   <a style="padding:10px" class="btn btn-info " href="user/instructor/<?=$row->id?>">View Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
