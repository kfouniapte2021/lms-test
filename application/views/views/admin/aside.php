...
<li class="<?=getActive('dashboard')?>"><a href="dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            ...
            <li class="<?=getActive('subjects')?>"><a  href="subjects"><i class="fa fa-list"></i> <span>Subjects</span></a></li>
            ...
            <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                       ...
                       <!-- <li><a href="<?php echo base_url();?>auth/view_users_archive"><i class="fa fa-user"></i> <span>Archive Users</span></a></li>-->
                        <li class="<?=getActive('auth/admins')?>"><a href="auth/admins"><i class="fa fa-user"></i> <span>Admins</span></a></li> 
        ...
        <!--user end -->
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="<?=getActive('cms')?>"><a href="cms"><i class="fa fa-list"></i> <span>Pages</span></a></li>
