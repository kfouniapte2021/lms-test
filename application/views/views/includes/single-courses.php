            ...
            <div class="container">
                <div class="page-title-content">
                    <ul>
                        ...
                        <li><a href="courses-2-columns-style-1.php">Courses</a></li>
                        ...
                        <div class="related-courses">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-courses-box mb-30">
                                        <div class="courses-image">
                                            <a href="single-courses.php" class="d-block"><img src="assets/img/courses/1.jpg" alt="image"></a>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single-courses-box mb-30">
                                        <div class="courses-image">
                                            <a href="single-courses.php" class="d-block"><img src="assets/img/courses/2.jpg" alt="image"></a>
